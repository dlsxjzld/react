...
counter.innerText = 3;
console.log(counter.innerText); //액션
...
var store = (0, _redux.createStore)(reducer); // render함수
...
render();
store.subscribe(render); //액션 발생시키기 (dispatch)

divToggle.onclick = function () {
  store.dispatch(toggleSwitch());
  console.log("divToggle_clicked");
};

btnIncrease.onclick = function () {
  store.dispatch(increase(1));
  console.log("increase_clicked");
};
